...
public class TestCambioOKEntrambi {

    @Rule
    public ActivityTestRule<PaginaSplash> mActivityTestRule = new ActivityTestRule<>(PaginaSplash.class);

    String mail = "alfonsodesilvestri@gmail.com";
    String tel = "3482858980";
    ...
    public void provaCambio() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.mailutente),
                        isDisplayed()));
        textView.check(matches(withText(mail)));
