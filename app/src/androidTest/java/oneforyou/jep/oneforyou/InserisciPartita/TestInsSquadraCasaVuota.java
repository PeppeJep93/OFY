...
public class TestInsSquadraCasaVuota {
    ...
    public void testIns() {
        ...
        ViewInteraction squadraC = onView(
                allOf(withId(R.id.squadracasa),
                        isDisplayed()));
        squadraC.perform(replaceText(""), closeSoftKeyboard());
        ...
        ViewInteraction quoO = onView(
                allOf(withId(R.id.quotaospite),
                        isDisplayed()));
        quoO.perform(replaceText("3"), closeSoftKeyboard());



        ViewInteraction data = onView(
                allOf(withId(R.id.datapartita), withText("10/2/2020"),
                        childAtPosition(
