...
public class TestAggiornaSquadreNumeri {
    ...
    public void agg() {
        ...
        ViewInteraction squadraC = onView(
                allOf(withId(R.id.squadracasa),
                        isDisplayed()));
        squadraC.perform(replaceText("1234"),closeSoftKeyboard());
        ...
        ViewInteraction squadraO = onView(
                allOf(withId(R.id.squadraospite),
                        isDisplayed()));
        squadraO.perform(replaceText("356"),closeSoftKeyboard());
        ...
        ViewInteraction quoP = onView(
                allOf(withId(R.id.quotapareggio),
                        isDisplayed()));
        quoP.perform(replaceText("2"),closeSoftKeyboard());
