...
public class TestAggiornaQuotaCaratteri {
    ...
    public void agg() {
        ...
        ViewInteraction quoO = onView(
                allOf(withId(R.id.quotaospite),
                        isDisplayed()));
        quoO.perform(replaceText("2"),closeSoftKeyboard());
        ...
        ViewInteraction quoP = onView(
                allOf(withId(R.id.quotapareggio),
                        isDisplayed()));
        quoP.perform(replaceText("3"),closeSoftKeyboard());
