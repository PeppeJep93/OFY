...
public class TestAccessoUserLungaPassPiena {
    ...
    public void testAccesso() {
         ...
         */
        username.perform(replaceText("CristoforoGiovannelli"), closeSoftKeyboard());
        ...
        ...ci scrive dentro una stringa
         */
        password.perform(replaceText("Panino90"), closeSoftKeyboard());
