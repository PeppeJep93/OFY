...
String nome = "Carlo";
        ...
        ...ci scrive dentro una stringa
         */
        user.perform(replaceText(nome), closeSoftKeyboard());
        ...
        ...ci scrive dentro una stringa
         */
        password1.perform(replaceText("Favola0"), closeSoftKeyboard());
        ...
        ...ci scrive dentro una stringa
         */
        password2.perform(replaceText("Favola0"), closeSoftKeyboard());
        ...
        cerca una view con quello specifico ID e...
         */
        ViewInteraction asd = onView(
                allOf(withId(R.id.dgtnome),
                        isDisplayed()));
         /*
        ...ci scrive dentro una stringa
         */
        asd.perform(replaceText("Carlo"), closeSoftKeyboard());
...
//        donna.perform(click());
        ...
        data di nascita il 4 Febbraio 2002
         */
