...
public class TestAccessoUserFalsaPassPiena {
    ...
    public void testAccesso() {
         ...
         */
        username.perform(replaceText("Ambrogio"), closeSoftKeyboard());
        ...
        ...ci scrive dentro una stringa
         */
        password.perform(replaceText("Calcio00"), closeSoftKeyboard());
