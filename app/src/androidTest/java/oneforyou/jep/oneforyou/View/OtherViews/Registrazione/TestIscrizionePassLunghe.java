...
public class TestIscrizionePassLunghe {
    ...
    public void testAccesso() {
        ...
        ...ci scrive dentro una stringa
         */
        password1.perform(replaceText("Ioooooooooooooooo3"), closeSoftKeyboard());
        ...
        ...ci scrive dentro una stringa
         */
        password2.perform(replaceText("Ioooooooooooooooo3"), closeSoftKeyboard());
/*
        cerca una view con quello specifico ID e...
         */
