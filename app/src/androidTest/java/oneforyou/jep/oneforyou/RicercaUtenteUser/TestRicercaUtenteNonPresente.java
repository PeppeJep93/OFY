package oneforyou.jep.oneforyou.RicercaUtenteUser;
...
public class TestRicercaUtenteNonPresente {
    ...
    public void testAccesso() {
         ...
         */
        username.perform(replaceText("PeppeJep93"), closeSoftKeyboard());
        ...
        ...ci scrive dentro una stringa
         */
        scrive.perform(replaceText("Vittorio"), closeSoftKeyboard());
