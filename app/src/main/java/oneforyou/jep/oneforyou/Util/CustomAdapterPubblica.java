...
public class CustomAdapterPubblica extends ArrayAdapter<Partite> {
    private int resource;
    private LayoutInflater inflater;
    private ArrayList<Partite> partite = new ArrayList<>();

    public CustomAdapterPubblica(Context context, int resourceId, int username, ArrayList<Partite> objects) {
    ...
    public View getView(int position, View v, ViewGroup parent) {
        if (v == null) {
            v = inflater.inflate(R.layout.elementopubblicazione, null);

            final EditText golcasa = (EditText) v.findViewById(R.id.GolCasa);
            final EditText golospite = (EditText) v.findViewById(R.id.Golospite);
        ...
        ImageView pubblica = (ImageView) v.findViewById(R.id.imageSpunta);
        ImageView aggiorna = (ImageView) v.findViewById(R.id.imageMatita);

        pubblica.setTag(position);
        aggiorna.setTag(position);

        EditText golcasa = (EditText) v.findViewById(R.id.GolCasa);
        EditText golospite = (EditText) v.findViewById(R.id.Golospite);

        golcasa.setText("" + c.getGolCasa());
        golospite.setText("" + c.getGolOspite());
        return v;
