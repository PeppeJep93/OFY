...
import oneforyou.jep.oneforyou.View.ViewUser.PaginaUtentiUtente;

public class CustomAdapterUtenti1 extends ArrayAdapter<Utenti> {
    private int resource;
    private LayoutInflater inflater;
    private ArrayList<Utenti> utenti = new ArrayList<>();

    public CustomAdapterUtenti1(Context context, int resourceId, int username, ArrayList<Utenti> objects) {
...
//            });
        ...
        fotoiv.setBackground(PaginaUtentiUtente.utentino);
