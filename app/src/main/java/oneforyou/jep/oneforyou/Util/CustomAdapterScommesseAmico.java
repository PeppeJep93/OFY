...
import oneforyou.jep.oneforyou.View.ViewUser.PaginaAltroUtente;

public class CustomAdapterScommesseAmico extends ArrayAdapter<Scommesse> {
    ...
    public CustomAdapterScommesseAmico(Context context, int resourceId, int username, ArrayList<Scommesse> objects) {
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        Partite match = PaginaAltroUtente.partite.get(position);
