...
public class CustomAdapterAggiornaElimina extends ArrayAdapter<Partite> {
    private int resource;
    private LayoutInflater inflater;
    private ArrayList<Partite> partite = new ArrayList<>();

    public CustomAdapterAggiornaElimina(Context context, int resourceId, int username, ArrayList<Partite> objects) {
    ...
    public View getView(int position, View v, ViewGroup parent) {
        if (v == null) {
            v = inflater.inflate(R.layout.elementoaggiornamento, null);
        }
        ...
        ImageView ivaggiorna = (ImageView) v.findViewById(R.id.imageViewAggiorna);
        ImageView ivelimina = (ImageView) v.findViewById(R.id.imageViewElimina);
        TextView tvaggiorna = (TextView) v.findViewById(R.id.textRelativeSinistro);
        TextView tvelimina = (TextView) v.findViewById(R.id.textRelativeDestro);

        ivaggiorna.setTag(position);
        ivelimina.setTag(position);
        tvaggiorna.setTag(position);
        tvelimina.setTag(position);
