...
public class AggiornaPunteggio extends AsyncTask<String, Void, String> {
    ...
    public AggiornaPunteggio(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String partita = params[0];
        String casa = params[1];
        String ospite = params[2];

        String login_url = Connector.db + "script/aggiornapunteggio.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("partita", "UTF-8") + "=" + URLEncoder.encode(partita, "UTF-8")  + "&" + URLEncoder.encode("casa", "UTF-8") + "=" + URLEncoder.encode(casa, "UTF-8")  + "&" + URLEncoder.encode("ospite", "UTF-8") + "=" + URLEncoder.encode(ospite, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
