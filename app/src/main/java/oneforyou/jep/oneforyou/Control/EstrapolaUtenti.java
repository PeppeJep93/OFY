...
public class EstrapolaUtenti extends AsyncTask<String, Void, String> {
    ...
    public EstrapolaUtenti(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/estrapolautenti.php";
        String resultado = "";
