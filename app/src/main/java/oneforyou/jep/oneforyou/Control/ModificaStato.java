...
public class ModificaStato extends AsyncTask<String, Void, String> {
    ...
    public ModificaStato(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/modificastato.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("account", "UTF-8") + "=" + URLEncoder.encode(account, "UTF-8") + "&" + URLEncoder.encode("stato", "UTF-8") + "=" + URLEncoder.encode(stato, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
