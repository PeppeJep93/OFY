...
public class AggiornaDataElimina extends AsyncTask<String, Void, String> {
    ...
    public AggiornaDataElimina(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/cambiadatapartita.php";
        String resultado = "";
