...
public class RimuoviScommessa extends AsyncTask<String, Void, String> {
    ...
    public RimuoviScommessa(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/rimuoviscommessa.php";
        String resultado = "";
