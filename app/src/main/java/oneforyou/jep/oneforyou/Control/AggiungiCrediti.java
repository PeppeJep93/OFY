...
public class AggiungiCrediti extends AsyncTask<String, Void, String> {
    ...
    public AggiungiCrediti(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String crediti = params[1];

        String login_url = Connector.db + "script/regalacrediti.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("account", "UTF-8") + "=" + URLEncoder.encode(account, "UTF-8") + "&" + URLEncoder.encode("crediti", "UTF-8") + "=" + URLEncoder.encode(crediti, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
