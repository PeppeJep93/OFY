...
public class ControlloTelefono extends AsyncTask<String, Void, String> {
    ...
    public ControlloTelefono(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/cellcontrol.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("cell", "UTF-8") + "=" + URLEncoder.encode(cell, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
