...
public class AggiornaFoto extends AsyncTask<String, Void, String> {
    ...
    public AggiornaFoto(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/aggiornafoto.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("account", "UTF-8") + "=" + URLEncoder.encode(account, "UTF-8") + "&" + URLEncoder.encode("foto", "UTF-8") + "=" + URLEncoder.encode(account + ".jpg", "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
