...
public class TuttiIcs extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        int partita = Integer.parseInt(params[0]);
        String login_url = Connector.db + "script/tuttiics.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("partita", "UTF-8") + "=" + URLEncoder.encode(partita+"", "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
