...
public class TogliRecensione extends AsyncTask<String, Void, String> {
    ...
    public TogliRecensione(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/toglirecensione.php";
        String resultado = "";
