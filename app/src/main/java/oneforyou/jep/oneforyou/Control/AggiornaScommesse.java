...
public class AggiornaScommesse extends AsyncTask<String, Void, String> {
    ...
    public AggiornaScommesse(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/aggiornascommesse.php";
        String resultado = "";
