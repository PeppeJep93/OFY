...
public class CambiaTelefono extends AsyncTask<String, Void, String> {
    ...
    public CambiaTelefono(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/cambiatelefono.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("account", "UTF-8") + "=" + URLEncoder.encode(account, "UTF-8") + "&" + URLEncoder.encode("tel", "UTF-8") + "=" + URLEncoder.encode(tel, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
