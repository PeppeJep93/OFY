...
public class EstrapolaRecensioni extends AsyncTask<String, Void, String> {
    ...
    public EstrapolaRecensioni(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/estrapolarecensioni.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("substring", "UTF-8") + "=" + URLEncoder.encode(substring, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
