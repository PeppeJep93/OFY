...
public class ControllaGiocate extends AsyncTask<String, Void, String> {
    ...
    public ControllaGiocate(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/controllagiocate.php";
        String resultado = "";
