...
public class AcquistaBuono extends AsyncTask<String, Void, String> {
    ...
    public AcquistaBuono(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String utente = params[1];
        String servizio = params[2];
        String data = params[3];
        String valore = params[4];
        String costo = params[5];

        String login_url = Connector.db + "script/acquistabuono.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("codice", "UTF-8") + "=" + URLEncoder.encode(codice, "UTF-8") + "&" + URLEncoder.encode("utente", "UTF-8") + "=" + URLEncoder.encode(utente, "UTF-8")  + "&" + URLEncoder.encode("servizio", "UTF-8") + "=" + URLEncoder.encode(servizio, "UTF-8")  + "&" + URLEncoder.encode("data", "UTF-8") + "=" + URLEncoder.encode(data, "UTF-8")  + "&" + URLEncoder.encode("valore", "UTF-8") + "=" + URLEncoder.encode(valore, "UTF-8")  + "&" + URLEncoder.encode("costo", "UTF-8") + "=" + URLEncoder.encode(costo, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
