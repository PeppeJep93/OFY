...
public class EstrapolaFollowers extends AsyncTask<String, Void, String> {
    ...
    public EstrapolaFollowers(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/estrapolafollowers.php";
        String resultado = "";
