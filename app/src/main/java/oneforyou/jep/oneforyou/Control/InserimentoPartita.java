...
public class InserimentoPartita extends AsyncTask<String, Void, String> {
    ...
    public InserimentoPartita(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String prono = params[10];

        String login_url = Connector.db + "script/inseriscipartita.php";
        String resultado = "";
