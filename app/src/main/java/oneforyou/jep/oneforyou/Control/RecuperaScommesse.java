...
public class RecuperaScommesse extends AsyncTask<String, Void, String> {
    ...
    public RecuperaScommesse(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/recuperascommesse.php";
        String resultado = "";
