...
public class PrendiScommesseUtente extends AsyncTask<String, Void, String> {
    ...
    public PrendiScommesseUtente(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/prendiscommesseutente.php";
        String resultado = "";
