...
public class EstrapolaAmici extends AsyncTask<String, Void, String> {
    ...
    public EstrapolaAmici(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/estrapolaamici.php";
        String resultado = "";
