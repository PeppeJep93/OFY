...
public class AggiornaColore extends AsyncTask<String, Void, String> {
    ...
    public AggiornaColore(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String colore = params[1];

        String login_url = Connector.db + "script/aggiornacolore.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("account", "UTF-8") + "=" + URLEncoder.encode(account, "UTF-8") + "&" + URLEncoder.encode("colore", "UTF-8") + "=" + URLEncoder.encode(colore, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
