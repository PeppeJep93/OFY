...
public class AggiornamentoErrori extends AsyncTask<String, Void, String> {
    ...
    public AggiornamentoErrori(Context ct) {
    ...
    protected void onPreExecute() {
        ...
        if (x==1)
            a.setMessage("Stiamo aspettando che Zaza la smetti di saltare!");
        if (x==2)
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String errori = params[0];
        String username = params[1];
        String login_url = Connector.db + "script/aggiornaerrori.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("user", "UTF-8") + "=" + URLEncoder.encode(username, "UTF-8") + "&" + URLEncoder.encode("errori", "UTF-8") + "=" + URLEncoder.encode(errori, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
