...
public class IncrementaRecensioni extends AsyncTask<String, Void, String> {
    ...
    public IncrementaRecensioni(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/incrementarecensioni.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("amico", "UTF-8") + "=" + URLEncoder.encode(amico, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
