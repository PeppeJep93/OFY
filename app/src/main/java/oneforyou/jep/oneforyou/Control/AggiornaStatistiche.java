...
public class AggiornaStatistiche extends AsyncTask<String, Void, String> {
    ...
    public AggiornaStatistiche(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String vinte = params[1];
        String media = params[2];

        String login_url = Connector.db + "script/aggiornastats.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("account", "UTF-8") + "=" + URLEncoder.encode(account, "UTF-8") + "&" + URLEncoder.encode("vinte", "UTF-8") + "=" + URLEncoder.encode(vinte, "UTF-8") + "&" + URLEncoder.encode("media", "UTF-8") + "=" + URLEncoder.encode(media, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
