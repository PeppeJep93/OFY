...
public class ModificaRuolo extends AsyncTask<String, Void, String> {
    ...
    public ModificaRuolo(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String ruolo = params[1];

        String login_url = Connector.db + "script/modificaruolo.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("account", "UTF-8") + "=" + URLEncoder.encode(account, "UTF-8") + "&" + URLEncoder.encode("ruolo", "UTF-8") + "=" + URLEncoder.encode(ruolo, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
