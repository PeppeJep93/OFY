...
public class RecuperaPartiteFinite extends AsyncTask<String, Void, String> {
    ...
    public RecuperaPartiteFinite(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/recuperafinite.php";
        String resultado = "";
