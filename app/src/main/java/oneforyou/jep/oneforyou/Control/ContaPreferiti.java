...
public class ContaPreferiti extends AsyncTask<String, Void, String> {
    ...
    public ContaPreferiti(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/contapreferiti.php";
        String resultado = "";
