...
public class AggiornaLegame extends AsyncTask<String, Void, String> {
    ...
    public AggiornaLegame(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String preferito = params[2];

        String login_url = Connector.db + "script/aggiornalegame.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("amico", "UTF-8") + "=" + URLEncoder.encode(amico, "UTF-8") + "&" + URLEncoder.encode("follow", "UTF-8") + "=" + URLEncoder.encode(follow, "UTF-8") + "&" + URLEncoder.encode("preferito", "UTF-8") + "=" + URLEncoder.encode(preferito, "UTF-8");bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
