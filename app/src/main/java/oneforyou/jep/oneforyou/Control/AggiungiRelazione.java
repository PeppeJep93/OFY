...
public class AggiungiRelazione extends AsyncTask<String, Void, String> {
    ...
    public AggiungiRelazione(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/aggiungirelazione.php";
        String resultado = "";
