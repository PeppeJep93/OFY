...
public class AggiornaSaldo extends AsyncTask<String, Void, String> {
    ...
    public AggiornaSaldo(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String paga = params[1];

        String login_url = Connector.db + "script/aggiornasaldo.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("account", "UTF-8") + "=" + URLEncoder.encode(account, "UTF-8") + "&" + URLEncoder.encode("paga", "UTF-8") + "=" + URLEncoder.encode(paga, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
