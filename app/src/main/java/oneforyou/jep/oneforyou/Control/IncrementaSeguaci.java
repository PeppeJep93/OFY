...
public class IncrementaSeguaci extends AsyncTask<String, Void, String> {
    ...
    public IncrementaSeguaci(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/incrementaseguaci.php";
        String resultado = "";
