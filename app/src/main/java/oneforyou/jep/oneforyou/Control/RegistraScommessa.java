...
public class RegistraScommessa extends AsyncTask<String, Void, String> {
    ...
    public RegistraScommessa(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String prono = params[2];
        String quota = params[3];
        String funny = params[4];
        String win = params[5];

        String login_url = Connector.db + "script/registrascommessa.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("account", "UTF-8") + "=" + URLEncoder.encode(account, "UTF-8") + "&" + URLEncoder.encode("match", "UTF-8") + "=" + URLEncoder.encode(match, "UTF-8") + "&" + URLEncoder.encode("prono", "UTF-8") + "=" + URLEncoder.encode(prono, "UTF-8") + "&" + URLEncoder.encode("quota", "UTF-8") + "=" + URLEncoder.encode(quota, "UTF-8") + "&" + URLEncoder.encode("funny", "UTF-8") + "=" + URLEncoder.encode(funny, "UTF-8") + "&" + URLEncoder.encode("win", "UTF-8") + "=" + URLEncoder.encode(win, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
