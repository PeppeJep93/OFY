...
public class ControlloDati extends AsyncTask<String, Void, String> {
    ...
    public ControlloDati(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/caricamentoprofilo.php";
        String resultado = "";
