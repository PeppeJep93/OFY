...
public class EliminaRelazione extends AsyncTask<String, Void, String> {
    ...
    public EliminaRelazione(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/eliminarelazione.php";
        String resultado = "";
