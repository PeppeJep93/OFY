...
public class EstrapolaPreferiti extends AsyncTask<String, Void, String> {
    ...
    public EstrapolaPreferiti(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/estrapolapreferiti.php";
        String resultado = "";
