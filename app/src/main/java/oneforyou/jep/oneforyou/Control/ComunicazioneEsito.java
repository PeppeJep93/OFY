...
public class ComunicazioneEsito extends AsyncTask<String, Void, String> {
    ...
    public ComunicazioneEsito(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String login_url = Connector.db + "script/comunicaesito.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("codice", "UTF-8") + "=" + URLEncoder.encode(codice, "UTF-8") + "&" + URLEncoder.encode("stato", "UTF-8") + "=" + URLEncoder.encode(stato, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
