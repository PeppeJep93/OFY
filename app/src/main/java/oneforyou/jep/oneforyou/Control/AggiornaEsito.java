...
public class AggiornaEsito extends AsyncTask<String, Void, String> {
    ...
    public AggiornaEsito(Context ct) {
    ...
    protected String doInBackground(String... params) { //sync
        ...
        String id = params[0];
        String esito = params[1];

        String login_url = Connector.db + "script/aggiornaesito.php";
        String resultado = "";
        ...
        try {
            ...
            String post_data = URLEncoder.encode("id", "UTF-8") + "=" + URLEncoder.encode(id, "UTF-8") + "&" + URLEncoder.encode("esito", "UTF-8") + "=" + URLEncoder.encode(esito, "UTF-8");
            bf.write(post_data);
            bf.flush();
            bf.close();
            out.close();
